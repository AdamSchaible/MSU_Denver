...
public class TEA_Decryption
{
    ...
    {
        TEA_Decryption tea2 = new TEA_Decryption();
        ...
        L[1] = tea2.subtractionMod32(R[2],tea2.F(R[1],K[2],K[3],DeltaTwo));
        R[0] = tea2.subtractionMod32(R[2],tea2.F(L[2],K[2],K[3],DeltaTwo));
        L[0] = tea2.subtractionMod32(L[2],tea2.F(R[0],K[0],K[1],DeltaOne));
    ...
    public long subtractionMod32(long number1, long number2)
    {
        long subtraction = number1 - number2;
        if (subtraction < 0)
        {
            String tempString = Long.toBinaryString(number1);
            ...
            long number1updated = Long.parseLong(tempString,2);//=2^33
            subtraction = number1updated - number2;
